...
const cartSlice = createSlice({
    ...
    reducers: {
        ...
        getCartTotal: (state) => {
            ...
            state.itemsCount = state.carts.reduce((quantityTotal, quantityItem) => {
                return quantityTotal += quantityItem.quantity;
            }, 0);
        },
...
export const {addToCart, removeFromCart, clearCart, getCartTotal, toggleCartQty,
              setCartMessageOn,setCartMessageOff} = cartSlice.actions;
